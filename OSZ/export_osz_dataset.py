...
--------
    ...
    #                       EMA weights work_dirs/resworld_config/
    ...
    python OSZ/export_osz_dataset.py --dataroot data/nuscenes \\
        ...
        --rcsample-ckpt work_dirs/resworld_config/epoch_12_ema.pth
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Trained ResWorld checkpoint (required for --depth-source "
             "rcsample), e.g. work_dirs/resworld_config/epoch_12_ema.pth "
    ...
    parser.add_argument(
        ...
        help="Geometry backend. auto=torch when a GPU is available, else "
             ...
             "--use_uncertainty forces numpy (not implemented in torch yet).")
